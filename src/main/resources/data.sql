...
INSERT INTO users (email, password, nickname, role, user_status, account_status, email_verified, deleted, created_at, updated_at, introduce, profile_image_url)
VALUES ('rhkdgh821@naver.com', '{bcrypt}$2a$10$fVn4lhyxvKSwaHQja3L4D.fTshkPTdWSEN8q9yEZ6OrmzwfoKwwB6', 'rhkdgh821', 'USER', 'ACTIVE', 'NORMAL', true, false, NOW(), NOW(), '자기소개를 입력해주세요.', 'uploads/default.png');
