...
public enum ErrorCode {
    ...
    OUTBOX_ALREADY_SUCCEEDED(HttpStatus.BAD_REQUEST, "이미 성공 처리된 아웃박스 이벤트입니다."),
    OUTBOX_ALREADY_PENDING(HttpStatus.BAD_REQUEST, "이미 재처리 대기 중인 아웃박스 이벤트입니다."),
    OUTBOX_ALREADY_PROCESSING(HttpStatus.CONFLICT, "현재 처리 중인 아웃박스 이벤트입니다."),
